...
alias mux="cd ${DOTFILES:-$HOME/Dropbox/Mackup} && find . -type f -name '.DS_Store' -ls -delete && mackup backup --force --root --verbose && git fetch --all --verbose && git submodule update --init --recursive --remote && git status --verbose"
