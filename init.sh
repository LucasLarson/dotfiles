...
if ! command -v apk >/dev/null 2>&1; then
  ...
  wget --output-document - http://web.archive.org/web/20201127185919id_/dl-cdn.alpinelinux.org/alpine/v3.12/main/x86/apk-tools-static-2.10.5-r1.apk | tar -xz apk.static && ./apk.static add apk-tools && rm apk.static
fi
